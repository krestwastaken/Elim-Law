...
import { faqData, contactCard, officeInfo } from "../Components/data";
        ...
        <div className="container mx-auto px-4 h-full flex items-center justify-center md:justify-start relative z-10">
          <div className="max-w-3xl text-white text-center md:text-left">
            ...
            <p className="text-sm md:text-lg mb-6 md:mb-8 px-2 md:px-0">
              ...
              provide you with personalized legal solutions. Contact us today to
              schedule your consultation.
            </p>

            {/* Contact Cards */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-6 md:mt-8">
              {contactCard.map(({ icon, title, text }, index) => (
                <div
                  key={index}
                  className="bg-white bg-opacity-10 backdrop-blur-sm p-4 md:p-6 rounded-lg text-center"
                >
                  <i
                    className={`${icon} text-2xl md:text-3xl mb-2 md:mb-3`}
                  ></i>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-lg shadow-lg mb-8">
              <h3 className="text-2xl font-serif font-bold text-[#004D2E] mb-6">
                Contact Information
              </h3>
                ...
                {officeInfo.map((info) => {
                  return (
                    <div className="flex items-start" key={info.id}>
                      ...
                      <div>
                        <h4 className="font-semibold text-[#004D2E] mb-1">
                          {info.title}
                        </h4>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Routes 8, 25, 26, 242 stop nearby
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#004D2E] mb-2">Parking</h4>
                  <p className="text-gray-600 text-sm">
                    Limited street parking available. NCP car park 2 minutes
                    walk.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            {faqData.map((faq, index) => (
              ...
              >
                ...
                >
                  <h3 className="text-lg font-semibold text-[#004D2E]">
                    {faq.question}
                  </h3>
                  <i
                    className={`fas ${
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We're here when you need us. Our flexible scheduling accommodates
              your busy lifestyle.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600 mb-4">
                24/7 emergency legal assistance available for urgent matters.
              </p>
